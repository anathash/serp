        ...
        <div class="jumbotron cloudy-knoxville-gradient">
            ...
            <div>
                <form action='submit.php' method='post'  onsubmit="return validateFormSubmit();">
					<div class="row">
						<p style="font-size:130%;"> Before we start, please supply the following personal details:</p>
					</div>
						<div class="row">
						...
						<div >
							<fieldset>
								...
								<select class="form-control dropdown" id="education_field" name="education_field" required>
									<option value="" selected="selected" disabled="disabled">-- select one --</option>
