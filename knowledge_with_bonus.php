    ...
    <div class="container">
        <div class="jumbotron cloudy-knoxville-gradient">
            <div class="container">
				...
				Use the links in the next page (click of at least one) to find the required answer. When you are ready, click the “Answer Question” button.
				<br>
				<br>
				...
				Our system will record your search behavior for academic research purposes. It is very important that you behave as if you are researching this topic for your own sake. 
				 <br>
				 If our data will show that your answers were qualified by the results presented to you and your search actions, you will be receive  a bonus of <span style="color: #FF0000">1$</span>
                <br>
				</h4>
                <br>
